...
A modern, feature-rich Java client for the LibreTranslate API with advanced capabilities including rate limiting, caching, and comprehensive monitoring. Compatible with JDK-11+.
...
- **JDK 8 Compatible** - Works with Java 8 and higher versions
...
<dependency>
    ...
    <artifactId>libretranslate-java-JDK11</artifactId>
...
```groovy
implementation 'com.vidigal.code:libretranslate-java-JDK11:1.0.0'
```
